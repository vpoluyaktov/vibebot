...
func TestSmartEditV2_AddImportGo(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddImportPython(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddImportJavaScript(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddImportJava(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddImportRust(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddImportC(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_AddFunction(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
...
func TestSmartEditV2_DuplicateImport(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSmartEditV2(registry, tmpDir)
