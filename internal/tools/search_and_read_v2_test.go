...
func TestSearchAndReadV2_FullMode(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_SummaryMode(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_OutlineMode(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_GrepFilter(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_MaxFiles(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_MultiLanguage(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_UnsupportedFormat(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_NoMatches(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
...
func TestSearchAndReadV2_IncludePrivate(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterSearchAndReadV2(registry, tmpDir)
