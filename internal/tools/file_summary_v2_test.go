...
func TestFileSummaryV2_MultiLanguage(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterFileSummaryV2(registry, tmpDir)
...
func TestFileSummaryV2_IncludePrivate(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterFileSummaryV2(registry, tmpDir)
...
func TestFileSummaryV2_UnsupportedLanguage(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterFileSummaryV2(registry, tmpDir)
...
func TestFileSummaryV2_Errors(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterFileSummaryV2(registry, tmpDir)
...
func TestFileSummaryV2_LineNumbers(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterFileSummaryV2(registry, tmpDir)
