...
func TestCodeContext_FindDefinitions(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestCodeContext_FindUsages(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterCodeContext(registry, tmpDir)
...
func TestCodeContext_MultiLanguage(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterCodeContext(registry, tmpDir)
...
func TestCodeContext_ExcludeTests(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterCodeContext(registry, tmpDir)
...
func TestCodeContext_NotFound(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterCodeContext(registry, tmpDir)
...
func TestCodeContext_ContextLines(t *testing.T) {
	tmpDir := t.TempDir()
	registry := NewRegistry()
	RegisterCodeContext(registry, tmpDir)
